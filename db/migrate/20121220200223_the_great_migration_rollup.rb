class TheGreatMigrationRollup < ActiveRecord::Migration[5.1]
  def change
    ...
    create_table "coppice", :id => false do |t|
      t.integer "treatment_id"
    ...
    create_table "planting", :id => false do |t|
    ...
    create_table "seeding", :id => false do |t|
      t.integer "treatment_id",  :limit => 1, :null => false
      t.integer "management_id", :limit => 1, :null => false
      t.integer "mgmttype",      :limit => 1, :null => false
      t.integer "date",          :limit => 1, :null => false
    ...
    create_table "simulationmodels" do |t|
      t.string   "model_name"
      t.string   "model_path"
    ...
    create_table "yields_view", :id => false do |t|
    ...
    create_table "yieldsview", :id => false do |t|
      t.integer "yield_id",     :limit => 1, :null => false
      t.integer "citation_id",  :limit => 1, :null => false
      t.integer "site_id",      :limit => 1, :null => false
      t.integer "site",         :limit => 1, :null => false
